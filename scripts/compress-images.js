#!/usr/bin/env node
/**
 * Compress all images in the image grid folder (Imgae test or public/Imgae test)
 * for the 4lights random grid. Runs automatically before build (prebuild) or via npm run compress-images.
 * Uses sharp for JPEG/PNG compression.
 */
...
async function main() {
  console.log('4lights image compression (random grid)\n');
